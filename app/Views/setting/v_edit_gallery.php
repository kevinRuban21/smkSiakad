<div class="col-md-12">
          <div class="card card-outline card-success">
            ...
            <?php echo form_open_multipart('Setting/UpdateDataGallery/' . $gallery['id_gallery']) ?>
            <!-- /.card-header -->
            <div class="card-body">
                <div class="form-group">
                    <label>Keterangan</label>
                    <input name="ket" value="<?= $gallery['ket'] ?>" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <img src="<?= base_url('gallery/' . $gallery['foto']) ?>" id="gambar_load" width="250vh">
                </div>
            </div>
