<div class="col-md-12">
          <div class="card card-outline card-success">
            ...
            <?php echo form_open_multipart('Setting/UpdateDataSlider/' . $slider['id_slider']) ?>
            <!-- /.card-header -->
            <div class="card-body">
                <div class="form-group">
                    <label>Judul Slider</label>
                    <input name="judul_slider" value="<?= $slider['judul_slider'] ?>" class="form-control">
                    <p class="text-danger"><?= $validasi->getError('judul_slider') ?></p>
                </div>
                <div class="form-group">
                    <label>Deskripsi Slider</label>
                    <input name="deskripsi_slider" value="<?= $slider['deskripsi_slider'] ?>" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <img src="<?= base_url('gambarslider/' . $slider['gambar_slider']) ?>" id="gambar_load" width="250vh">
                </div>
            </div>
