...
<?php 
        ...
        $mapel = $db->table('tbl_mapel')->where('id_mapel', 1)->get()->getResultArray();
?>
  ...
  <aside class="main-sidebar sidebar-dark-success elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?= base_url('fotoguru') ?>/<?= session()->get('foto_guru') ?>" class="img-circle elevation-2" alt="Admin" style="opacity: .8">
        </div>
        <div class="info">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item <?= $menu == 'akademik' ? 'menu-open' : ''  ?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?= base_url('JadwalGuru') ?>" class="nav-link <?= $submenu == 'jadwal-guru' ? 'active' : ''  ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Jadwal Mengajar</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= base_url('InputNilai') ?>" class="nav-link <?= $submenu == 'nilai' ? 'active' : ''  ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Nilai Siswa</p>
                </a>
              </li>
